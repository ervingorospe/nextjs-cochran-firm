...
export function LocationCard({ data }) {
  ...
  return (
    <Link href={fields.googleMapUrl} target="_blank"className="rounded-md bg-secondary-800 p-4 md:p-5 hover:bg-secondary-700 transition duration-300 ease-in-out">
      <p className="text-left text-lg font-medium uppercase tracking-wide text-primary-400 md:text-xl">{ data.name }</p>
      <div className="mt-2 space-y-2 text-secondary-100 md:mt-3">
        {
