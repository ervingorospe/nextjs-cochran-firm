...
export function ImageLeft({ data, marginTop, sectionCount, navigation }) {
  const { fields } = data
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="absolute -bottom-[12%] -top-[12%] -left-1/3 hidden lg:w-[37vw] xl:w-[43vw] 2xl:w-[39.3vw] bg-secondary-100 bg-gradient-to-r from-secondary-100 to-secondary-50 lg:block">
