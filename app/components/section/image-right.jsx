...
export function ImageRight({ data, marginTop, sectionCount, navigation }) {
  const { fields } = data
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="absolute -bottom-[12%] -top-[12%] left-1/4 hidden lg:w-[37vw] xl:w-[43vw] 2xl:w-[39.3vw] bg-secondary-100 bg-gradient-to-r from-secondary-100 to-secondary-50 lg:block">
            ...
            </div>
            {
              ...
              (
                <ImageHolder
                  image={fields.image} 
                  styles={{
                    figure: "relative z-1 overflow-hidden rounded-xl",
                    image: "h-full w-auto rounded-xl"
                  }}
                />
              )
            }
