...
export function ImageRightBigImageDetachedTitle({ data, marginTop, sectionCount, navigation }) {
  const { fields } = data
      ...
      >
        ...
        >
          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-2 xl:grid-cols-12">
            ...
            >
              <div className="absolute -top-[12%] -bottom-[12%] left-1/4 hidden lg:w-[37vw] xl:w-[43vw] 2xl:w-[44.2vw] bg-secondary-100 bg-gradient-to-r from-secondary-100 to-secondary-50 lg:block">
