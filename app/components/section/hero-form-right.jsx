...
// components
import { SectionButtons, SectionTitles, SectionBody, WufooFormWithParams } from '@/components/shared'


export function HeroFormRight({ data, marginTop, sectionCount }) {
  const { fields } = data
  ...
  return (
    ...
    >
      ...
      >
        <div className="grid items-top gap-8 lg:grid-cols-2 lg:gap-16">
          <motion.div 
            className="lg:mt-6"
            initial="hidden"
            whileInView="visible"
          ...
          <WufooFormWithParams fields={fields}/>
        </div>
      </Container>
      <div className="absolute inset-0">
        ...
        <svg className="absolute left-0 right-0 bottom-0 scale-y-flipped transform fill-current text-secondary-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1338 50">
