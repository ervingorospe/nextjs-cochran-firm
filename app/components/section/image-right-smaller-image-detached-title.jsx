...
export function ImageRightSmallerImageDetachedTitle({ data, marginTop, sectionCount, navigation }) {
  const { fields } = data
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="mt-6 grid lg:grid-cols-2 xl:grid-cols-12">
            <motion.div 
              className="mx-auto relative xl:col-span-4"
              variants={fadeInFromBottom}
            >
              <div className="absolute -top-[12%] -bottom-[12%] left-1/4 hidden lg:w-[37vw] xl:w-[43vw] 2xl:w-[30.4vw] bg-secondary-100 bg-gradient-to-r from-secondary-100 to-secondary-50 lg:block">
            ...
            <div className="xl:col-span-8 lg:row-start-1 mt-4 lg:mt-0">
              {/* Body */}
              <SectionBody
                fields={fields}
                motionStyle={{
