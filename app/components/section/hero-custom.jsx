...
// components
import { SectionButtons, SectionTitles, SectionBody, VideoHolder, ImageHolder } from '@/components/shared'
// function
import { containerMotion, fadeInFromBottom } from "@/function/framer-animation";


export function HeroCustom({ data, marginTop, sectionCount, navigation }) {
  const { fields } = data
                  ...
                  _.get(fields, 'video') && (
                    ...
                    >
                      <VideoHolder 
                        ...
                        styles={{
                          image: "aspect-w-16 aspect-h-9 overflow-hidden rounded-xl",
                        }}
                      />
                    </motion.div>
                  )
                  ...
                  !_.get(fields, 'video') && _.get(fields, 'image') && (
                    ...
                    >
                      <ImageHolder 
                        image={fields.image} 
                        styles={{
                          figure: "aspect-w-16 aspect-h-9 overflow-hidden rounded-xl",
